/* Runtime dump - SettingsAccessibilityCaptioningSizeController
...
{
    NSNumber * _selectedRelativeSize;
}
...
- (SettingsAccessibilityCaptioningSizeController *)initWithTitle:(NSString *)arg0 andProfileID:(NSString *)arg1;
- (void)_reloadList;
