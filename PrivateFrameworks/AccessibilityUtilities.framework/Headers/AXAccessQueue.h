...
- (AXAccessQueue *)initWithParentClass:(Class)arg0 description:(NSString *)arg1 appendUUIDToLabel:(char)arg2;
...
- (AXAccessQueue *)initWithLabel:(NSString *)arg0 appendUUIDToLabel:(char)arg1;
