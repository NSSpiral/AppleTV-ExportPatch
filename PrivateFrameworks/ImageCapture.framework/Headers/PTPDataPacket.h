...
- (PTPDataPacket *)initWithTCPBuffer:(void *)arg0;
- (unsigned short)operationCode;
- (PTPDataPacket *)initWithOperationCode:(unsigned short)arg0 transactionID:(unsigned long)arg1 andData:(NSData *)arg2;
- (void)setTransactionID:(unsigned long)arg0;
- (long long)copyToBuffer:(void *)arg0 numBytes:(long long)arg1;
- (NSString *)filepath;
- (PTPDataPacket *)initWithOperationCode:(unsigned short)arg0 transactionID:(unsigned long)arg1 andFilepath:(id)arg2;
- (PTPDataPacket *)initWithUSBBuffer:(void *)arg0;
- (id)contentForUSB;
...
- (long long)copyDataToWrappedBytes:(NSData *)arg0 forTransport:(unsigned short)arg1 fromOffset:(unsigned long long)arg2;
- (long long)copyHeaderToWrappedBytes:(NSData *)arg0 forTransport:(unsigned short)arg1;
