/* Runtime dump - OISFUMoveableFileOutputStream
...
- (long long)offset;
- (void)close;
- (OISFUMoveableFileOutputStream *)initWithPath:(NSString *)arg0;
- (NSInputStream *)inputStream;
- (void)seekToOffset:(long long)arg0 whence:(int)arg1;
- (char)canCreateInputStream;
- (OISFUMoveableFileOutputStream *)initWithTemporaryFile:(NSString *)arg0;
