/* Runtime dump - OITSURegularExpression
...
- (void)dealloc;
- (OITSURegularExpression *)initWithCoder:(NSCoder *)arg0;
- (void)encodeWithCoder:(NSCoder *)arg0;
- (OITSURegularExpression *)init;
- (char)isEqual:(NSObject *)arg0;
- (unsigned int)hash;
- (OITSURegularExpression *)copyWithZone:(struct _NSZone *)arg0;
- (OITSURegularExpression *)initWithExpressionString:(NSString *)arg0;
- (OITSURegularExpression *)initWithExpressionString:(NSString *)arg0 options:(unsigned int)arg1;
