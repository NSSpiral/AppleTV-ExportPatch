/* Runtime dump - TSKCOIdPlacementRearrangeOperation
...
- (TSKCOIdPlacementRearrangeOperation *)initWithUnarchiver:(NSUnarchiver *)arg0 message:(struct Operation *)arg1;
...
- (TSKCOIdPlacementRearrangeOperation *)initWithIdAddress:(NSString *)arg0 fromIndex:(int)arg1 toIndex:(int)arg2 dominating:(char)arg3 noop:(char)arg4;
...
- (TSKCOIdPlacementRearrangeOperation *)initWithIdAddress:(NSString *)arg0 fromIndex:(int)arg1 toIndex:(int)arg2;
