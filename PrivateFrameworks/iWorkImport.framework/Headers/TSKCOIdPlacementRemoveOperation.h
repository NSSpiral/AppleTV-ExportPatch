/* Runtime dump - TSKCOIdPlacementRemoveOperation
...
- (TSKCOIdPlacementRemoveOperation *)initWithUnarchiver:(NSUnarchiver *)arg0 message:(struct Operation *)arg1;
...
- (TSKCOIdPlacementRemoveOperation *)initWithIdAddress:(NSString *)arg0 fromIndex:(int)arg1 toIndex:(int)arg2 dominating:(char)arg3 noop:(char)arg4;
- (int)objectCount;
- (int)objectCounterSpace;
- (TSKCOIdPlacementRemoveOperation *)initWithIdAddress:(NSString *)arg0 fromIndex:(int)arg1 toIndex:(int)arg2 dominating:(char)arg3 noop:(char)arg4 objectCount:(int)arg5 objectCounterSpace:(int)arg6;
...
- (TSKCOIdPlacementRemoveOperation *)initWithIdAddress:(NSString *)arg0 fromIndex:(int)arg1 objectCount:(int)arg2 objectCounterSpace:(int)arg3;
- (TSKCOIdPlacementRemoveOperation *)initWithIdAddress:(NSString *)arg0 fromIndex:(int)arg1;
